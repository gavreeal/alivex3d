...
function arc90_extlink() {
	...
	var ice = "localhost";
	var usq = "usq.edu.au";
	var alive = "alivex3d.org";
	var sci = "sci.usq.edu.au";
	var blog = "alivex3d.wordpress.com";
	var ggroup = "http://groups.google.com/group/alivex3dusers/"
	
	if(b=="") b="file://"
	var A = document.getElementsByTagName('A');
	for (var i = 0, l = A.length; i < l; i++) {
		var a = A[i];
		if (((b != '' && a.href.indexOf(b) < 0 && a.href.indexOf(ice) < 0 && a.href.indexOf(alive) < 0 && a.href.indexOf(sci) < 0 && a.href.indexOf(usq) < 0 && a.href.indexOf(blog) < 0 && a.href.indexOf(ggroup) < 0) || b == '') && a.href.indexOf('://') > 0 && ((arc90_extLinkUseClassName && a.className.indexOf('extlink') >= 0) || !arc90_extLinkUseClassName)) {
            try {
